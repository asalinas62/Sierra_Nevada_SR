...
para_ini0[0]= rs0_ajus_mediaMes[f1i_pos] # Valores de pico para
para_ini0[1]= rs0_ajus_mediaMes[f2i_pos] # las frecuencias iniciales
para_ini0[2]= rs0_ajus_mediaMes[f3i_pos]
para_ini1[0]= rs1_ajus_mediaMes[f1i_pos] # Valores de pico para
para_ini1[1]= rs1_ajus_mediaMes[f2i_pos] # las frecuencias iniciales
...
# Con esta funcion se calcula la diferencia entre las medidas, data, y 
# los valores de la funcion, model, aplicado a las frecuencias, x
# Se diferencian las dos funciones, lorentz y gaussian
